...
export const documentKinds: readonly DocumentKindDefinition[] = [
  ...
  def("capital_request_letter", "Carta de pedido de capital", "Capital request letter", "company_document", "institutional_and_corporate", ["transaction", "project", "company"], ["carta", "pedido", "racional", "cfo", "capital request"]),
