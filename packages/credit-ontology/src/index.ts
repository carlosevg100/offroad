 ...
 * reconciliation rule catalog and financial definitions.
 ...
 */
export const ontologyVersion = "2026.09.01-v5";
...
export * from "./debt-mission";
export * from "./jurisdiction-language";
