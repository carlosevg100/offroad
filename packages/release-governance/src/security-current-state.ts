...
const canonicalSecurityCoverageCatalogue = [
  ...
  },
  {
    ...
    evidenceRequirements: [
      ...
      {evidenceRef: "SEV-RETENTION-MATRIX", criterion: "Versioned account/model/resource eligibility with bounded retention and fail-closed unknown combinations."},
      {evidenceRef: "SEV-RETENTION-SERVER", criterion: "Current source and dependency retention rights are rechecked by capability-scoped SQL."},
      {evidenceRef: "SEV-RETENTION-SQL-TEST", criterion: "Negative tests cover expired attestations, revoked sources and capability forgery."},
      {evidenceRef: "SEV-RETENTION-RESEARCH", criterion: "Public research transport is authorized for each resource and refuses redirects."},
