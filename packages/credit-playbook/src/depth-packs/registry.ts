...
export const dcmDepthPacks: readonly CanonicalDepthPack[] = [
  pack({
    ...
    calculationPolicy: "required", calculationIds: ["financial.accounting_identity", "financial.debt_views", "financial.net_leverage"],
    calculationRationale: "A identidade financeira, as visões de dívida e a alavancagem são o núcleo determinístico de qualquer trabalho DCM.",
    ...
    qualityGateIds: ["gate.evidence-lineage", "gate.numeric-reconciliation", "gate.no-silent-completeness", "gate.professional-boundary"],
  }),
  pack({
  ...
  pack({
    ...
    calculationPolicy: "required", calculationIds: ["financial.cfads", "financial.cash_conversion", "financial.rate_shock", "financial.currency_exposure", "financial.liquidity_coverage", "structure.coverage_series", "structure.covenant_headroom"],
