...
export const growthCapexProcedures = [
  ...
  candidate({
    ...
    product: "Roadmap mínimo, alvo e ideal, com lote atual igual ao resíduo, cada item com motivo e substitutos claros.",
    ...
    steps: [
      ...
      step("rank", "Selecionar a próxima melhor solicitação", "deterministic", ["Priorizar bloqueador, impacto em capacidade, impacto em estrutura, impacto em mandato e só depois acabamento.", "Mostrar o lote residual completo, cada item com por que importa, decisão que altera e substitutos."], ["client_request_ranker"]),
    ],
    ...
    redFlags: ["Checklist genérico igual para todos os casos", "Item ativo sem motivo ou sem decisão que altera", "Pedido de data room previamente organizado", "Solicitação de certidões antes de existir alternativa de estrutura"],
    ...
    outputFields: [
      {id: "current_batch", type: "array", required: true, description: "Lote residual completo de solicitações priorizadas, cada uma com motivo e substitutos."},
  ...
  candidate({
    ...
    steps: [
      ...
      step("rank", "Liberar lote curto", "deterministic", ["Ordenar por materialidade e dependência.", "Exibir o lote residual completo, cada item com motivo e decisão que altera."], ["client_request_ranker"]),
    ],
    ...
    outputFields: [
      {id: "request_batch", type: "array", required: true, description: "Lote residual completo de solicitações atuais, cada uma com motivo."},
    ...
    adversarial: ["informação indisponível permanece aberta sem invenção", "lote nunca é cortado nem preenchido por número"],
  }),
