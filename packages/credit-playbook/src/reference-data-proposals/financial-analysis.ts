...
export const financialAnalysisProposals: ReferenceDataProposalFamily = {
  ...
  "policy.financial.materiality": {
    ...
    value: {
      ...
      individualFormula: "M = fração do benchmark de individual × multiplicador de qualidade da base de onde vem o item; o multiplicador não se aplica aos critérios de efeito (0,05x e 10% da folga)",
      ...
      covenantProximity: {definitionKey: "policy.structure.covenant_headroom", definitionField: "existingCovenants.nearCovenantRule", consumedShareMaterial: "0.10"},
      workingCapitalPhoto: {
        photoEffectShareOfAverage: "0.10",
        photoEffectAlsoAtLeast: "M de resultado",
      ...
      laborRecurring: {windowFiscalYears: 3, fiscalYearsWithDisbursement: 3, averageAnnualDisbursementAtLeast: "M de resultado (individual.ebitdaShare × multiplicador de qualidade, com lowEbitdaFallback)"},
      alwaysMaterial: [
  ...
  "policy.financial.normalization": {
    ...
    value: {
      ...
      views: [
        ...
        {id: "reclassified", order: 2, basis: "o mesmo conteúdo econômico na convenção da casa, sem julgamento de recorrência: arrendamentos pela convenção declarada, equivalência fora do EBITDA, risco sacado pela substância, variação cambial e derivativos de dívida fora do EBITDA, hedge operacional dentro do EBITDA somente com designação contábil da receita ou do custo protegido", overwritesPrevious: false},
      ...
      leaseConvention: {
        ...
        postIfrs16When: "a definição aplicável a exige",
      ...
      closingIdentity: "soma dos ajustes aceitos mais o reportado reclassificado é igual ao ajustado, sem tolerância econômica",
      ...
      constantCurrency: {
        ...
        constantCurrencyGrowth: "crescimento recalculado com o período corrente convertido às taxas médias do período anterior, ao lado do crescimento reportado",
      },
      catalogue: [
  ...
  "policy.cash-flow.bridge": {
    ...
    value: {
      ...
      operatingBridge: [
        ...
        {order: 7, line: "recurring_operating_commitments", sign: "-", source: "compromissos operacionais recorrentes e mínimos contratados, inclusive o desembolso trabalhista recorrente de Q-15"},
      ...
      cashAvailableForDebtService: [
        {order: 9, line: "opening_free_cash", sign: "+", source: "caixa e aplicações de liquidez imediata menos caixa restrito menos o caixa mínimo operacional de policy.capacity.minimum_headroom"},
      ...
      obligations: [
        ...
        {line: "contracted_expansion_capex", source: "capex de expansão contratado; o não contratado fica fora do CFADS e das obrigações"},
      ...
      minimumOperatingCash: {key: "policy.capacity.minimum_headroom", field: "liquidityFloor", rule: "abatido do caixa livre inicial na linha 9"},
      ...
      liquidityCoverage: {
        ...
        floorHorizonAndPeriodicity: {key: "policy.capacity.minimum_headroom", fields: ["liquidityFloor", "horizonByArchetype"]},
        fullTenorAnnualView: "teste de DSCR de policy.structure.coverage-floors sobre o cronograma inteiro",
    ...
    unit: "linhas ordenadas com sinal; frações da conversão; cobertura em vezes (x) pelas fórmulas desta chave",
    source: {
  ...
  "policy.capex.maintenance": {
    ...
    value: {
      ...
      estimationHierarchy: [
        ...
        {rank: 4, method: "management_engineering_estimate", confidence: "low", bandShare: "0.35", evidence: ["entrevista técnica registrada"], floor: "nunca abaixo do método 3 quando os dois existem"},
        {rank: 5, method: "peer_ratio", confidence: "low", bandShare: "0.35", minimumPeers: 5, source: "pares de market.peer-benchmarks que divulgam capex de manutenção separado", formula: "razão entre capex de manutenção e depreciação dos pares, aplicada à depreciação da companhia"},
      ],
      ...
      tenorVsEconomicLife: {maxFinalMaturityShareOfRemainingLife: "0.80", economicLife: "menor entre a vida útil contábil revisada e o horizonte de substituição tecnológica ou regulatória", balloonAtMost: "valor residual do ativo depois do haircut de policy.structure.collateral_haircuts"},
      sourcesAndUses: {maintenanceShareOfUsesReview: "0.20", appliesTo: "operação declarada como expansão", rule: "capex de manutenção financiado pela operação é linha própria nos usos; acima do limiar, numa operação declarada como expansão, revisar liquidez disfarçada (IN-23) e uso misto (OP-13)"},
  ...
  "policy.related-party.materiality": {
    ...
    value: {
      ...
      circularity: {
        trigger: "fluxo material pelos limiares de flows, mais mútuo, mais garantia cruzada, com a mesma parte ou o mesmo grupo",
        ...
        selfFinancedSales: {
          rule: "no mesmo período de análise, a companhia empresta à mesma parte ou ao mesmo grupo econômico e vende a ela, e a menor das duas pernas alcança a materialidade de receita de policy.financial.materiality",
          counterparty: "a mesma parte relacionada ou o mesmo grupo econômico, somadas as entidades",
          loanLeg: "valor emprestado pela companhia no período",
          salesLeg: "receita de vendas à mesma parte ou grupo no período",
          materialityKey: "policy.financial.materiality",
          materialityTest: "menor perna >= individual.netRevenueShare × receita líquida dos últimos doze meses × multiplicador de qualidade da base",
          revenueShareScreenApplies: false,
        },
  ...
  "policy.seasonality.materiality": {
    ...
    value: {
      ...
      quarterShare: {
        ...
        patternShift: "participação do trimestre na receita do ciclo comparada com a do mesmo trimestre do ciclo anterior; variação relativa que alcança o limiar é achado de mudança do padrão sazonal e reabre a janela: os índices usam os dois últimos ciclos e o memo nomeia a mudança",
      },
      statisticByPurpose: {
  ...
  "policy.currency.exposure": {
    ...
    value: {
      ...
      materiality: {
        primaryShockEffectAtLeastIndividualMateriality: true,
        equivalentNetShortExposureShareOfEbitda: "0.04",
        equivalentNetLongExposureShareOfEbitda: "0.05",
        leverageDeltaMultipleFromPrimaryShock: "0.05",
        highPrimaryShockEffectShareOfCfads: "0.10",
        highLeverageDeltaMultiple: "0.25",
        rule: "material quando o efeito do choque isolado de 25% sobre a exposição líquida de 12 meses alcança a materialidade individual de policy.financial.materiality (com multiplicador de qualidade 1,00, exposição passiva líquida de 4% do EBITDA, ou ativa de 5%) ou move a alavancagem em 0,05x; alta quando o efeito alcança 10% do CFADS ou 0,25x de alavancagem",
      },
      mixWindow: {
      ...
      isolatedShocks: {
        role: "sensibilidade isolada de câmbio (Q-12): materialidade, classificação da exposição e teste reverso; os cenários combinados downside e severo de D-27 usam a depreciação de scenario.market.multi-factor",
        base: "curva de dólar futuro da B3 na data-base para o horizonte; sem vértice, mediana do relatório Focus do Banco Central",
        primaryShockShare: "0.25",
        secondShockShare: "0.50",
        ...
        horizonMonths: 12,
        reverseTest: "obrigatório quando a exposição é alta: a variação cambial contra a exposição líquida que zera a folga do covenant mais apertado ou leva o caixa ao mínimo",
        combinedScenariosKey: "scenario.market.multi-factor",
      ...
      rule: "mapear por moeda e entidade, medir a exposição líquida de 12 meses, testar os choques isolados contra a materialidade e o covenant, e contar hedge somente contratado e casado",
    },
    ...
    value: {
      ...
      provisionCoverage: {
        ...
        proxyWhenHistoryShorterThanWindow: {
          ...
          monthsSinceDefaultIndexing: "o primeiro mês de inadimplemento é o mês 0: o elemento i do vetor vale para o mês i",
  ...
  "policy.concentration.materiality": {
    ...
    value: {
      ...
      rule: "agrupar, rankear, classificar cada dimensão pela banda mais alta alcançada entre maior, cinco maiores e dez maiores e aplicar a consequência da banda; banda alta ou severa sem análise da contraparte impede conclusão de capacidade",
    },
  ...
  "market.peer-benchmarks": {
    ...
    value: {
      units,
      purpose: "faixa de margem dos pares para RF-03 e para a normalização de margem no downside; nunca para preço, alavancagem de referência ou capacidade",
      peerSet: {
