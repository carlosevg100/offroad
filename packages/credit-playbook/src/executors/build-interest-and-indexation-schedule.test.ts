...
const camil = (): InterestScheduleInput => ({
  ...
  series: [
    ...
    {id: "deb-15-1", label: "15ª 1ª série 105% do DI", openingPrincipal: {value: "770123", basis: "ledger_balance_including_accrued", anchor: itr(39, "15; o relatório fiduciário registra nominal de 765.389")}, openingAccrued: null, indexer: "CDI", remuneration: {type: "percent_of_index", percentOfIndex: "1.05"}, couponDates: [{date: "2026-11-13", businessDaysFromPeriodStart: 53}, {date: "2027-05-14", businessDaysFromPeriodStart: 52}], amortization: null, indexationTreatment: null, indexation: null, rounding: null, curveId: "cdi-bcb-2026-09-04", anchors: {balance: itr(39, "15"), terms: {document: "af_15a_emissao.pdf", page: 2}, payments: esc("escritura_15a_emissao.pdf", "7.8"), amortization: null}},
