...
result_contract: method.declare-scenarios.v6
...
- Choque ou haircut de zero não é estresse e é recusado; EBITDA de doze meses é declarado por datas, não por rótulo; documentos entram com nome e hash conferidos contra o manifesto do corpus (nomes duplicados no manifesto e leituras duplicadas por instrumento são recusados). No corpus congelado do caso 01 nenhuma premissa de CFADS, choque ou rolagem tem fonte: o conjunto mínimo fica bloqueado e nada é preenchido; a mecânica é exercida em fixture hipotética declarada.
...
# Outputs
- schema_version (string, required): `method.declare-scenarios.v6`
