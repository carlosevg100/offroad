...
result_contract: method.reconcile-covenant-definitions.v5
...
# Outputs
- schema_version (string, required): identificador do contrato de resultado, `method.reconcile-covenant-definitions.v5`
- as_of_date (date, required): data-base da comparação
- unit (string, required): unidade de todos os valores monetários do resultado e do trace; entra no fingerprint, para que uma troca uniforme de escala mude o resultado
