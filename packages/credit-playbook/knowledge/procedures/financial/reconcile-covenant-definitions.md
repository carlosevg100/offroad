...
result_contract: method.reconcile-covenant-definitions.v8
...
# Outputs
- schema_version (string, required): identificador do contrato de resultado, `method.reconcile-covenant-definitions.v8`
