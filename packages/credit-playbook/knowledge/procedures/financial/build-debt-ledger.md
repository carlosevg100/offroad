...
result_contract: method.build-debt-ledger.v9
...
# Outputs
- schema_version (string, required): identificador do contrato de resultado, `method.build-debt-ledger.v9`
