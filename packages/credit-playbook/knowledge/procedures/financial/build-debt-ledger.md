...
result_contract: method.build-debt-ledger.v7
...
# Outputs
- schema_version (string, required): identificador do contrato de resultado, `method.build-debt-ledger.v7`
...
- by_indexer (array, required): saldo e participação por indexador, com dois denominadores nomeados: a dívida bruta antes dos custos de transação e a dívida bruta da nota (a que dá os 13,1% de IPCA e 19,4% em moeda estrangeira do gabarito)
