...
Sujeito: método `diagnose-maturity-wall` versão 2026.09.05-v5 em `packages/credit-playbook/knowledge/procedures/refinance/diagnose-maturity-wall.md`; executor em
