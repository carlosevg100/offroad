...
Sujeito: método `build-interest-and-indexation-schedule` versão 2026.09.05-v5 em `packages/credit-playbook/knowledge/procedures/financial/build-interest-and-indexation-schedule.md`; executor em
`packages/credit-playbook/src/executors/build-interest-and-indexation-schedule.ts`; testes em `packages/credit-playbook/src/executors/build-interest-and-indexation-schedule.test.ts`. Contrato: `packages/credit-playbook/src/procedure-contract.ts`.
