...
Sujeito: método `build-interest-and-indexation-schedule` versão 2026.09.05-v4 em `packages/credit-playbook/knowledge/procedures/financial/build-interest-and-indexation-schedule.md`; executor em
