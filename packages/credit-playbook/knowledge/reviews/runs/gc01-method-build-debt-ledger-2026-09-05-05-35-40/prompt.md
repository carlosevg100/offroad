...
Sujeito: método `build-debt-ledger` versão 2026.09.05-v13 em `packages/credit-playbook/knowledge/procedures/financial/build-debt-ledger.md`; executor em
`packages/credit-playbook/src/executors/build-debt-ledger.ts`; testes em `packages/credit-playbook/src/executors/build-debt-ledger.test.ts`. Contrato: `packages/credit-playbook/src/procedure-contract.ts`.
