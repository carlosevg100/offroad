...
Sujeito: método `diagnose-maturity-wall` versão 2026.09.05-v6 em `packages/credit-playbook/knowledge/procedures/refinance/diagnose-maturity-wall.md`; executor em
`packages/credit-playbook/src/executors/diagnose-maturity-wall.ts`; testes em `packages/credit-playbook/src/executors/diagnose-maturity-wall.test.ts`. Contrato: `packages/credit-playbook/src/procedure-contract.ts`.
