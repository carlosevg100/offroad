...
Sujeito: método `reconcile-financial-statements` versão 2026.09.05-v7 em `packages/credit-playbook/knowledge/procedures/financial/reconcile-financial-statements.md`; executor em
`packages/credit-playbook/src/executors/reconcile-financial-statements.ts`; testes em `packages/credit-playbook/src/executors/reconcile-financial-statements.test.ts`. Contrato: `packages/credit-playbook/src/procedure-contract.ts`.
