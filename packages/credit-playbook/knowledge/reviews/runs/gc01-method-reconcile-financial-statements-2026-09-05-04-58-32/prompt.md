...
Sujeito: método `reconcile-financial-statements` versão 2026.09.05-v5 em `packages/credit-playbook/knowledge/procedures/financial/reconcile-financial-statements.md`; executor em
