...
Sujeito: método `reconcile-covenant-definitions` versão 2026.09.05-v10 em `packages/credit-playbook/knowledge/procedures/financial/reconcile-covenant-definitions.md`; executor em
