...
Sujeito: método `estimate-exit-cost-by-series` versão 2026.09.05-v4 em `packages/credit-playbook/knowledge/procedures/refinance/estimate-exit-cost-by-series.md`; executor em
`packages/credit-playbook/src/executors/estimate-exit-cost-by-series.ts`; testes em `packages/credit-playbook/src/executors/estimate-exit-cost-by-series.test.ts`. Contrato: `packages/credit-playbook/src/procedure-contract.ts`.
