...
Sujeito: método `compare-refinancing-before-after` versão 2026.09.05-v2 em `packages/credit-playbook/knowledge/procedures/refinance/compare-refinancing-before-after.md`; executor em
