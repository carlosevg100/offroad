...
Sujeito: método `compare-refinancing-before-after` versão 2026.09.05-v3 em `packages/credit-playbook/knowledge/procedures/refinance/compare-refinancing-before-after.md`; executor em
`packages/credit-playbook/src/executors/compare-refinancing-before-after.ts`; testes em `packages/credit-playbook/src/executors/compare-refinancing-before-after.test.ts`. Contrato: `packages/credit-playbook/src/procedure-contract.ts`.
