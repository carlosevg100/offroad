...
Sujeito: método `plan-meeting-brief` versão 2026.09.05-v3 em `packages/credit-playbook/knowledge/procedures/materials/plan-meeting-brief.md`; executor em
`packages/credit-playbook/src/executors/plan-meeting-brief.ts`; testes em `packages/credit-playbook/src/executors/plan-meeting-brief.test.ts`. Contrato: `packages/credit-playbook/src/procedure-contract.ts`.
