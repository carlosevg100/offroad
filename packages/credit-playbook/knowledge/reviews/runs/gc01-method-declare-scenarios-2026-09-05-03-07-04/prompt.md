...
Sujeito: método `declare-scenarios` versão 2026.09.05-v1 em `packages/credit-playbook/knowledge/procedures/scenarios/declare-scenarios.md`; executor em
`packages/credit-playbook/src/executors/declare-scenarios.ts`; testes em `packages/credit-playbook/src/executors/declare-scenarios.test.ts`. Contrato: `packages/credit-playbook/src/procedure-contract.ts`.
