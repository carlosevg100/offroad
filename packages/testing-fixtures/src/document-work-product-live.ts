...
export const documentWorkProductLiveCases = [
  ...
  {id: "review", job: "review", objective: "Review this credit opportunity for our internal investment team. Identify transaction terms, protections, risks and diligence questions without an approval recommendation.", expected: ["24 months", "unsecured", "quarterly compliance certificate", "leverage"], passages: [
