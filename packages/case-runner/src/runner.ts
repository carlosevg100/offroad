...
export const caseTaskSpecs = [
  ...
  {id: "structure", workflow: "case", phase: "structure", version: "1", dependencies: ["reconciliation", "metrics"], allowedTools: ["financial_core", "deal_structure", "instrument_catalogue", "market_reference"], effect: "propose_state", executionClass: "deterministic"},
  ...
  {id: "claims", workflow: "case", phase: "prepare", version: "1", dependencies: ["reconciliation", "metrics"], allowedTools: ["case_brief_writer", "claim_auditor"], effect: "propose_state", executionClass: "model"},
  {id: "materials", workflow: "case", phase: "prepare", version: "1", dependencies: ["extraction", "reconciliation", "metrics", "structure", "red_flags", "claims"], allowedTools: ["case_materials", "data_room", "claim_registry"], effect: "compile_artifact", executionClass: "deterministic"},
