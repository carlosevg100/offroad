...
export const caseTaskSpecs = [
  ...
  {id: "claims", workflow: "case", phase: "prepare", version: "2", dependencies: ["reconciliation", "metrics", "structure"], allowedTools: ["case_brief_writer", "claim_auditor"], effect: "propose_state", executionClass: "model"},
