...
const exit = executors.estimateExitCostBySeries({exitDate, unit: "BRL thousand", series: [
  {id: "deb-13-1", label: "13ª emissão, 1ª série", nominalAtExit: null, accruedAtExit: null, chargesAtExit: null, mechanisms: [{mechanism: "extraordinary_amortization_di", premiumPerYear: "0.004", availableFrom: "2026-05-14", businessDays: {count: executors.weekdaysBetween(exitDate, "2028-11-14"), maturity: "2028-11-14", anchor: calendarNote("2028-11-14")}, anchor: {document: "escritura_13a_emissao.pdf", clause: "7.18"}}], anchor: {document: "escritura_13a_emissao.pdf", clause: "4.1"}},
  {id: "deb-14-1", label: "14ª emissão, 1ª série", nominalAtExit: null, accruedAtExit: null, chargesAtExit: null, mechanisms: [{mechanism: "extraordinary_amortization_di", premiumPerYear: "0.004", availableFrom: "2026-06-15", businessDays: {count: executors.weekdaysBetween(exitDate, "2030-11-14"), maturity: "2030-11-14", anchor: calendarNote("2030-11-14")}, anchor: {document: "escritura_14a_emissao.pdf", clause: "7.20"}}], anchor: {document: "escritura_14a_emissao.pdf", clause: "4.1"}},
  {id: "deb-11", label: "11ª emissão", nominalAtExit: null, accruedAtExit: null, chargesAtExit: null, mechanisms: [{mechanism: "negotiated_offer", availableFrom: "2021-11-15", premium: null, requiresFullAdherence: true, anchor: {document: "escritura_11a_emissao.pdf", clause: "4.14"}}], anchor: {document: "escritura_11a_emissao.pdf", clause: "4.1"}},
]});
const premium = (id: string) => {
  const entry = exit.exit_costs.find((cost) => cost.series_id === id)!;
  return entry.cheapest_unilateral ? {value: d(entry.cheapest_unilateral.total_payable).minus(entry.base.payable ?? 0).toFixed(), anchor: {document: "exit-costs-gc05.json", note: `route ${entry.cheapest_unilateral.mechanism}`}} : null;
};
