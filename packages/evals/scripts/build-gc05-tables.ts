...
const beforeAfter = (rate: string, termMonths: number) => executors.compareRefinancingBeforeAfter({
  ...
  alternatives: [
    ...
    {id: "x-extend-di-2028", label: "X: alongar a parede de 2028/29 retirando a 13ª 1ª série", newDebt: {amount: "306038", annualRate: rate, termMonths, graceMonths: 24, format: "sac", upfrontFeeRate: "0.005", disbursementDate: exitDate, origin: "custo de referência do pedido simulado (CDI + 1,25%), sintético", anchor: {document: "03_Pedido_Simulado_CRA_2026.docx", page: 1}}, retired: [{seriesId: "deb-13-1", instalments: [{period: "2028/29", principal: {value: "306038", anchor: itr(39, "nota 15, saldo contábil de deb-13-1")}, maturityAnchor: {document: "escritura_13a_emissao.pdf", clause: "4.1"}}], exitPremium: premium("deb-13-1")}]},
    {id: "y-extend-both", label: "Y: alongar as duas paredes retirando a 13ª 1ª e a 14ª 1ª séries", newDebt: {amount: "744956", annualRate: rate, termMonths, graceMonths: 24, format: "sac", upfrontFeeRate: "0.005", disbursementDate: exitDate, origin: "idem", anchor: {document: "03_Pedido_Simulado_CRA_2026.docx", page: 1}}, retired: [{seriesId: "deb-13-1", instalments: [{period: "2028/29", principal: {value: "306038", anchor: itr(39, "nota 15, saldo contábil de deb-13-1")}, maturityAnchor: {document: "escritura_13a_emissao.pdf", clause: "4.1"}}], exitPremium: premium("deb-13-1")}, {seriesId: "deb-14-1", instalments: [{period: "2029/30", principal: {value: "438918", anchor: itr(39, "nota 15, saldo contábil de deb-14-1")}, maturityAnchor: {document: "escritura_14a_emissao.pdf", clause: "4.1"}}], exitPremium: premium("deb-14-1")}]},
    {id: "offer-11th", label: "Retirar a 11ª por oferta (prêmio a negociar)", newDebt: null, retired: [{seriesId: "deb-11", instalments: [{period: "2028/29", principal: {value: "657779", anchor: itr(39, "nota 15, saldo contábil de deb-11")}, maturityAnchor: {document: "escritura_11a_emissao.pdf", clause: "4.1"}}], exitPremium: premium("deb-11")}]},
  ],
