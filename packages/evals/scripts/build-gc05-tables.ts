...
const exit = executors.estimateExitCostBySeries({exitDate, unit: "BRL thousand", documents: exitDocuments, series: [
  {id: "deb-13-1", label: "13ª emissão, 1ª série", indenture: {document: "escritura_13a_emissao.pdf", clause: "4.1"}, nominalAtExit: null, accruedAtExit: null, chargesAtExit: null, remainingFlows: null, remunerationRate: null, quantity: null, indentureMechanisms: [], mechanisms: [{mechanism: "extraordinary_amortization_di", premiumPerYear: "0.004", availableFrom: "2026-05-14", maxFraction: "0.98", fraction: "0.98", businessDays: {count: executors.weekdaysBetween(exitDate, "2028-11-14"), maturity: "2028-11-14", holidays: {count: 0, anchor: calendarNote("2028-11-14")}, anchor: calendarNote("2028-11-14")}, anchor: {document: "escritura_13a_emissao.pdf", clause: "7.18"}}], anchor: {document: "escritura_13a_emissao.pdf", clause: "4.1"}},
  {id: "deb-14-1", label: "14ª emissão, 1ª série", indenture: {document: "escritura_14a_emissao.pdf", clause: "4.1"}, nominalAtExit: null, accruedAtExit: null, chargesAtExit: null, remainingFlows: null, remunerationRate: null, quantity: null, indentureMechanisms: [], mechanisms: [{mechanism: "extraordinary_amortization_di", premiumPerYear: "0.004", availableFrom: "2026-06-15", maxFraction: "0.98", fraction: "0.98", businessDays: {count: executors.weekdaysBetween(exitDate, "2029-06-14"), maturity: "2029-06-14", holidays: {count: 0, anchor: calendarNote("2029-06-14")}, anchor: calendarNote("2029-06-14")}, anchor: {document: "escritura_14a_emissao.pdf", clause: "7.20"}}], anchor: {document: "escritura_14a_emissao.pdf", clause: "4.1"}},
  {id: "deb-11", label: "11ª emissão", indenture: {document: "escritura_11a_emissao.pdf", clause: "4.1"}, nominalAtExit: null, accruedAtExit: null, chargesAtExit: null, remainingFlows: null, remunerationRate: null, quantity: null, indentureMechanisms: [], mechanisms: [{mechanism: "negotiated_offer", availableFrom: "2021-11-15", premium: null, requiresFullAdherence: true, anchor: {document: "escritura_11a_emissao.pdf", clause: "4.14"}}], anchor: {document: "escritura_11a_emissao.pdf", clause: "4.1"}},
]});
const premium = (id: string) => {
  const entry = exit.exit_costs.find((cost) => cost.series_id === id)!;
  return entry.cheapest_full_exit ? {value: d(entry.cheapest_full_exit.total_payable).minus(entry.base.payable ?? 0).toFixed(), mechanism: entry.cheapest_full_exit.mechanism, permittedOnDate: true, anchor: {document: "exit-costs-gc05.json", note: `route ${entry.cheapest_full_exit.mechanism}`}} : null;
};
...
const beforeAfter = (rate: string, termMonths: number) => executors.compareRefinancingBeforeAfter({
  ...
  before: {
    ...
    ltmEbitda: {value: "895864", periodStart: "2025-05-31", periodEnd: "2026-05-31", definitionKey: "ebitda.contractual.13a", basis: "implied_from_reported_index", anchor: itr(40, "nota 15: 4.228.477 / 4,72, derivado")},
    schedule: [{period: "2026/27", amount: "1229828", endsAt: "2027-05-31", anchor: itr(40, "nota 15, cronograma")}, {period: "2027/28", amount: "776868", endsAt: "2028-05-31", anchor: itr(40, "nota 15, cronograma")}, {period: "2028/29", amount: "1228475", endsAt: "2029-05-31", anchor: itr(40, "nota 15, cronograma")}, {period: "2029/30", amount: "694497", endsAt: "2030-05-31", anchor: itr(40, "nota 15, cronograma")}, {period: "2030/31", amount: "994544", endsAt: "2031-05-31", anchor: itr(40, "nota 15, cronograma")}, {period: "after 2031", amount: "809198", endsAt: null, anchor: itr(40, "nota 15, cronograma")}, {period: "debenture costs", amount: "-63224", endsAt: null, kind: "adjustment", anchor: itr(40, "nota 15, cronograma")}],
  ...
  alternatives: [
    ...
    {id: "x-extend-di-2028", label: "X: alongar a parede de 2028/29 retirando a 13ª 1ª série", newDebt: {amount: "304160", annualRate: rate, termMonths, graceMonths: 24, format: "sac", upfrontFeeRate: "0.005", disbursementDate: exitDate, origin: "custo de referência do pedido simulado (CDI + 1,25%), sintético", termsSource: "indicative_unverified", anchor: {document: "03_Pedido_Simulado_CRA_2026.docx", page: 1}}, retired: [{seriesId: "deb-13-1", instalments: [{period: "2028/29", principal: {value: "304160", basis: "contractual_nominal", anchor: {document: "af_13a_emissao.pdf", note: "relatório anual do agente fiduciário: quantidade emitida e em circulação 304.160 debêntures a R$ 1.000, em milhares de reais; nominal contratual, não saldo contábil"}}, maturityAnchor: {document: "escritura_13a_emissao.pdf", clause: "4.1"}}], exitPremium: premium("deb-13-1")}]},
    {id: "y-extend-both", label: "Y: alongar as duas paredes retirando a 13ª 1ª e a 14ª 1ª séries", newDebt: {amount: "715803", annualRate: rate, termMonths, graceMonths: 24, format: "sac", upfrontFeeRate: "0.005", disbursementDate: exitDate, origin: "idem", termsSource: "indicative_unverified", anchor: {document: "03_Pedido_Simulado_CRA_2026.docx", page: 1}}, retired: [{seriesId: "deb-13-1", instalments: [{period: "2028/29", principal: {value: "304160", basis: "contractual_nominal", anchor: {document: "af_13a_emissao.pdf", note: "relatório anual do agente fiduciário: quantidade emitida e em circulação 304.160 debêntures a R$ 1.000, em milhares de reais; nominal contratual, não saldo contábil"}}, maturityAnchor: {document: "escritura_13a_emissao.pdf", clause: "4.1"}}], exitPremium: premium("deb-13-1")}, {seriesId: "deb-14-1", instalments: [{period: "2029/30", principal: {value: "411643", basis: "contractual_nominal", anchor: {document: "af_14a_emissao.pdf", note: "relatório anual do agente fiduciário: quantidade emitida e em circulação 411.643 debêntures a R$ 1.000, em milhares de reais; nominal contratual, não saldo contábil"}}, maturityAnchor: {document: "escritura_14a_emissao.pdf", clause: "4.1"}}], exitPremium: premium("deb-14-1")}]},
    {id: "offer-11th", label: "Retirar a 11ª por oferta (prêmio a negociar)", newDebt: null, retired: [{seriesId: "deb-11", instalments: [{period: "2028/29", principal: {value: "650000", basis: "contractual_nominal", anchor: {document: "escritura_11a_emissao.pdf", clause: "3.5.1", note: "650.000 debêntures a R$ 1.000 de valor nominal, em milhares de reais; amortizações posteriores não verificadas na base"}}, maturityAnchor: {document: "escritura_11a_emissao.pdf", clause: "4.1"}}], exitPremium: premium("deb-11")}]},
  ],
