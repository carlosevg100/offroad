...
const exit = executors.estimateExitCostBySeries({
  ...
  series: [
    {id: "deb-11-1", label: "11ª emissão, 1ª série", indenture: {document: "escritura_11a_emissao.pdf", clause: "4.1"}, nominalAtExit: null, accruedAtExit: null, chargesAtExit: null, remainingFlows: null, remunerationRate: null, quantity: null, indentureMechanisms: [], mechanisms: [{mechanism: "negotiated_offer", availableFrom: "2021-11-15", premium: null, requiresFullAdherence: true, anchor: {document: "escritura_11a_emissao.pdf", clause: "4.14"}}], anchor: {document: "escritura_11a_emissao.pdf", clause: "4.1"}},
    {id: "deb-11-2", label: "11ª emissão, 2ª série", indenture: {document: "escritura_11a_emissao.pdf", clause: "4.1"}, nominalAtExit: null, accruedAtExit: null, chargesAtExit: null, remainingFlows: null, remunerationRate: null, quantity: null, indentureMechanisms: [], mechanisms: [{mechanism: "negotiated_offer", availableFrom: "2021-11-15", premium: null, requiresFullAdherence: true, anchor: {document: "escritura_11a_emissao.pdf", clause: "4.14"}}], anchor: {document: "escritura_11a_emissao.pdf", clause: "4.1"}},
    {id: "deb-13-1", label: "13ª emissão, 1ª série", indenture: {document: "escritura_13a_emissao.pdf", clause: "4.1"}, nominalAtExit: null, accruedAtExit: null, chargesAtExit: null, remainingFlows: null, remunerationRate: null, quantity: null, indentureMechanisms: [], mechanisms: [{mechanism: "extraordinary_amortization_di", premiumPerYear: "0.004", availableFrom: "2026-05-14", maxFraction: "0.98", fraction: "0.98", businessDays: {count: weekdays(exitDate, "2028-11-14"), maturity: "2028-11-14", holidays: {count: 0, anchor: calendarNote("2028-11-14")}, anchor: calendarNote("2028-11-14")}, anchor: {document: "escritura_13a_emissao.pdf", clause: "7.18"}}], anchor: {document: "escritura_13a_emissao.pdf", clause: "4.1"}},
    {id: "deb-14-1", label: "14ª emissão, 1ª série", indenture: {document: "escritura_14a_emissao.pdf", clause: "4.1"}, nominalAtExit: null, accruedAtExit: null, chargesAtExit: null, remainingFlows: null, remunerationRate: null, quantity: null, indentureMechanisms: [], mechanisms: [{mechanism: "extraordinary_amortization_di", premiumPerYear: "0.004", availableFrom: "2026-06-15", maxFraction: "0.98", fraction: "0.98", businessDays: {count: weekdays(exitDate, "2029-06-14"), maturity: "2029-06-14", holidays: {count: 0, anchor: calendarNote("2029-06-14")}, anchor: calendarNote("2029-06-14")}, anchor: {document: "escritura_14a_emissao.pdf", clause: "7.20"}}], anchor: {document: "escritura_14a_emissao.pdf", clause: "4.1"}},
  ],
});
...
const result = executors.compareRefinancingBeforeAfter({
  ...
  alternatives: [
    ...
    {id: "extend-di-2028", label: "Alongar o pico de 2028/29: nova dívida de sete anos (CDI + 1,25%, dois de carência, SAC) retirando a 13ª 1ª série pelo prêmio da escritura", newDebt: newDebt("304160"), retired: [{seriesId: "deb-13-1", instalments: [{period: "2028/29", principal: {value: "304160", basis: "contractual_nominal", anchor: {document: "af_13a_emissao.pdf", note: "relatório anual do agente fiduciário: quantidade emitida e em circulação 304.160 debêntures a R$ 1.000, em milhares de reais; nominal contratual, não saldo contábil"}}, maturityAnchor: {document: "escritura_13a_emissao.pdf", clause: "4.1", note: "vencimento 14/11/2028"}}], exitPremium: premium("deb-13-1")}]},
    {id: "extend-di-2028-and-2029", label: "Alongar os dois picos: nova dívida de sete anos retirando a 13ª 1ª série e a 14ª 1ª série pelo prêmio da escritura", newDebt: newDebt("715803"), retired: [
      {seriesId: "deb-13-1", instalments: [{period: "2028/29", principal: {value: "304160", basis: "contractual_nominal", anchor: {document: "af_13a_emissao.pdf", note: "relatório anual do agente fiduciário: quantidade emitida e em circulação 304.160 debêntures a R$ 1.000, em milhares de reais; nominal contratual, não saldo contábil"}}, maturityAnchor: {document: "escritura_13a_emissao.pdf", clause: "4.1", note: "vencimento 14/11/2028"}}], exitPremium: premium("deb-13-1")},
      {seriesId: "deb-14-1", instalments: [{period: "2029/30", principal: {value: "411643", basis: "contractual_nominal", anchor: {document: "af_14a_emissao.pdf", note: "relatório anual do agente fiduciário: quantidade emitida e em circulação 411.643 debêntures a R$ 1.000, em milhares de reais; nominal contratual, não saldo contábil"}}, maturityAnchor: {document: "escritura_14a_emissao.pdf", clause: "4.1", note: "vencimento 14/06/2029"}}], exitPremium: premium("deb-14-1")},
    ]},
