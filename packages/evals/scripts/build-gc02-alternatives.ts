...
const exit = executors.estimateExitCostBySeries({
  ...
  series: [
    {id: "deb-11-1", label: "11ª emissão, 1ª série", indenture: {document: "escritura_11a_emissao.pdf", clause: "4.1"}, nominalAtExit: null, accruedAtExit: null, chargesAtExit: null, remainingFlows: null, remunerationRate: null, mechanisms: [{mechanism: "negotiated_offer", availableFrom: "2021-11-15", premium: null, requiresFullAdherence: true, anchor: {document: "escritura_11a_emissao.pdf", clause: "4.14"}}], anchor: {document: "escritura_11a_emissao.pdf", clause: "4.1"}},
    {id: "deb-11-2", label: "11ª emissão, 2ª série", indenture: {document: "escritura_11a_emissao.pdf", clause: "4.1"}, nominalAtExit: null, accruedAtExit: null, chargesAtExit: null, remainingFlows: null, remunerationRate: null, mechanisms: [{mechanism: "negotiated_offer", availableFrom: "2021-11-15", premium: null, requiresFullAdherence: true, anchor: {document: "escritura_11a_emissao.pdf", clause: "4.14"}}], anchor: {document: "escritura_11a_emissao.pdf", clause: "4.1"}},
