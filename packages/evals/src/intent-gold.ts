...
export const intentGoldTurns: readonly IntentGoldTurn[] = [
  ...
  gold({id: "hx02", caseId: "horizontal", suite: "horizontal", composition: "understand_company_sector_asset", message: "Explique como funciona uma debênture incentivada e em que ela difere de uma CCB, sem analisar uma empresa específica.", semantic: {canonicalAction: "understand", objectKinds: ["instrument"], materialReferences: ["debênture", "CCB"], desiredOutcomeSignals: [["explicar", "diferença"], ["debênture", "CCB"]], decision: none, audienceCategory: self}}),
