...
const contracts = Object.fromEntries((["company_debt_view", "origination_thesis", "capital_planning", "structure_from_documents", "review_existing_operation", "prepare_materials_and_process"] as const).map(entry => [entry, documentWorkPlanSnapshot(entry)]));
