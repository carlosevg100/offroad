...
export const financialCalculationRegistry = {
  ...
  "financial.indexed_rate_composition": "composeIndexAndSpread",
  "financial.percent_of_di_annual_rate": "annualRateForPercentOfDi",
  "financial.spread_over_index": "spreadOverIndex",
