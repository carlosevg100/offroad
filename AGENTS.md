...
[`docs/product/PRODUCT_WORKFLOW.md`](docs/product/PRODUCT_WORKFLOW.md). Read all four before
changing home, onboarding, pipeline order, user-visible progress, materials, matching or
introduction. Full orientation lives in [`handoff.md`](handoff.md). The historical linear build
