...
import {agentOperationBriefJobSchema} from "./queue";
...
function fixture(){
 ...
 return {context,candidate,configuration:data("configuration"),artifact:data("artifact")};
}
