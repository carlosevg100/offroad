...
import {shadowIntentEnvelope, shadowRoutingOutputSchema, type ShadowRoutingContext} from "./intent-shadow";
...
const context: ShadowRoutingContext = {
  ...
  entryJob: "origination_thesis", accessBasis: "public_information", documentIds: [], professionalContext: null,
};
