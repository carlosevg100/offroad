...
export const DOCUMENT_ALLOWED_EXTENSIONS = new Set(["pdf", "csv", "xls", "xlsx", "doc", "docx", "ppt", "pptx", "txt", "jpg", "jpeg", "png", "webp"]);
export const DOCUMENT_MAX_BYTES = 52_428_800;
export const DOCUMENT_MAX_FILES_PER_BATCH = 20;
export const DOCUMENT_ACCEPT = ".pdf,.csv,.xls,.xlsx,.doc,.docx,.ppt,.pptx,.txt,.jpg,.jpeg,.png,.webp";
