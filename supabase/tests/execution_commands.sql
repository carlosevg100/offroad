...
select private.reserve_execution_operation_v1((request->>'jobId')::uuid,claim->>'capability',(claim->>'leaseId')::uuid,'a4171000-0000-4000-9000-000000000002',repeat('a',64),'synthetic#calculate','test-v1','read_only',0,0) from execution_fixture;
do $$ declare r jsonb;begin
 select private.reserve_execution_operation_v1((request->>'jobId')::uuid,claim->>'capability',(claim->>'leaseId')::uuid,'a4171000-0000-4000-9000-000000000002',repeat('a',64),'synthetic#calculate','test-v1','read_only',0,0) into r from execution_fixture;
