...
reset role;
do $$ begin
  if (select count(*) from private.institutional_revision_proposals
      where organization_id='20000000-0000-4000-8000-000000000b01'
        and capital_project_id='30000000-0000-4000-8000-000000000b01')<>1 then raise exception 'the same file opened a second review'; end if;
