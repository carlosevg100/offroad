...
select pg_temp.metadata_mutation_denied('work archival invalidates receipt',$q$update public.capital_projects set status='archived' where id='30000000-0000-4000-8000-000000000731'$q$);
