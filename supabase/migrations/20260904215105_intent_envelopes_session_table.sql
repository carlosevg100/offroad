-- The previous replacement named the session table wrongly: the table is document_intake_sessions.
-- Same contract; the lookup now resolves on a fresh database as well as on the project.
