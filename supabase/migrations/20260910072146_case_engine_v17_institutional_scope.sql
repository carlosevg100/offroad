-- Admit institutional model implementation v17 without copying any earlier accreditation.
...
declare
  ...
  old_guard text := $guard$(p_scope_id is null or p_scope_id not in ('case-analysis:2026.08.29-v15', 'case-analysis:2026.09.09-v16'))$guard$;
  new_guard text := $guard$(p_scope_id is null or p_scope_id not in ('case-analysis:2026.08.29-v15', 'case-analysis:2026.09.09-v16', 'case-analysis:2026.09.10-v17'))$guard$;
begin
