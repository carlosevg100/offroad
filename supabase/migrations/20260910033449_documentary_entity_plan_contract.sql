-- Preserve approved v11 and earlier snapshots; add exact v12/entity-aware method v9.
create or replace function private.is_released_documentary_plan_v11(p_snapshot jsonb, p_entry text)
...
$function$;
revoke all on function private.is_released_documentary_plan_v11(jsonb,text) from public,anon,authenticated;
