...
- The founder's follow-up replaces generic benefit summaries with practitioner-built workflows, intent-specific method, execution capacity and capital fit, in that order. PT uses "Feita por quem fez o trabalho", "Cada pedido, o método certo", "Mais tempo para a decisão" and "Capital com aderência". The finance/AI section explains how analyst, MD and CFO requests require different work. The investor entry now says "Fale com nosso time" / "Talk to our team", with conversational contact copy in both languages. No implementation or closing claim is added.
...
The follow-up wording revision passed full local pnpm check, including 679 web tests and the production build. PT 1440 x 900 and 390 x 844, plus EN 1280 x 720 and 320 x 740, were checked in the browser without horizontal overflow. The PT investor CTA navigates to the revised contact heading. Only viewport simulation was used, not a physical handset. The previous remote database failure remains unresolved; the founder's copy feedback does not authorize changing SQL, merging PR603 or bypassing that gate. Keep this wording revision in the local preview pending that separate decision.
