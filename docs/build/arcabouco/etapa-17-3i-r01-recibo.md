...
Migração aplicada e catálogo conferido em 23/09/2026: produção `20260923145742`, staging `20260923145522`. Dez objetos novos com definições de catálogo idênticas, sem acesso por roles da API. Testes SQL de recibo, autoridade de preparo e perfil R01 passaram em staging com rollback; nenhum registro sintético permaneceu. Tipos públicos regenerados sem mudança. Segurança em produção: zero alertas. A publicação e os deployments ainda dependem da CI final.
