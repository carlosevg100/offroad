...
Migração aplicada em 23/09/2026: staging `20260923153636`, produção `20260923154150`. As três definições de função e permissões conferem entre ambientes; journals371/385. Quinze asserções novas e regressões SQL passaram na CI e em staging com rollback. Checkers: 18 testes PASS. Segurança: zero alertas; tipos públicos regenerados sem mudança. A revisão independente foi fechada após os sete negativos adicionais. CI final, merge e implantação ainda são requisitos do completion.
