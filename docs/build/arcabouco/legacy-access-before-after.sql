...
select jsonb_build_object(
 'project_title_visible',exists(select 1 from public.capital_projects where id='a11b0000-0000-4000-9000-000000000002'),
 'session_visible',exists(select 1 from public.document_intake_sessions where id='a11b0000-0000-4000-9000-000000000003'),
 'source_metadata_visible',exists(select 1 from public.source_documents where id='a11b0000-0000-4000-9000-000000000004'),
 'message_visible',exists(select 1 from public.agent_messages where id='a11b0000-0000-4000-9000-000000000007'),
 'retrieval_chunk_visible',exists(select 1 from public.case_retrieval_chunks where intake_session_id='a11b0000-0000-4000-9000-000000000003'),
 'opportunity_helper_accepts_nonexistent_id',private.can_access_opportunity('a11b0000-0000-4000-9000-000000000001','a11b0000-0000-4000-9000-000000000099','evidence.read')
) as result;
rollback;
