...
Metadados de implementação vinculam o export real e o contrato capital-procedure-packet.v1. Os estados são resultados do domínio e derived_on_demand descreve recomputação em memória; não há alegação de tabela, task ou jornada de usuário conectada. Evals de ponta a ponta declarados são de domínio; execução persistida continua na17.
