...
do $$ begin
if private.can_access_document_scope('a11b0000-0000-4000-9000-000000000001','a11b0000-0000-4000-9000-000000000003','document.write') then raise exception 'fixture unexpectedly has document write'; end if;
end $$;
select public.record_document_verification('a11b0000-0000-4000-9000-000000000001','a11b0000-0000-4000-9000-000000000004',repeat('b',64),'clean');
reset role;
select sha256=repeat('b',64) as unauthorized_hash_changed,sha256_verified_at is not null as unauthorized_verification_recorded from public.source_documents where id='a11b0000-0000-4000-9000-000000000004';
rollback;