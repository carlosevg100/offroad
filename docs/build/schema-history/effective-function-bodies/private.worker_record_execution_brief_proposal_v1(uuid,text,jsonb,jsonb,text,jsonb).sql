CREATE OR REPLACE FUNCTION private.worker_record_execution_brief_proposal_v1(p_job_id uuid, p_capability_token text, p_internal_snapshot jsonb, p_visible_snapshot jsonb, p_expected_input_fingerprint text, p_plan jsonb DEFAULT NULL::jsonb)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO ''
...
begin
  context:=private.worker_load_proposal_v1_before_scope(p_job_id,p_capability_token);
