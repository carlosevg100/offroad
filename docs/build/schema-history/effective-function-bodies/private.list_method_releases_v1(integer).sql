CREATE OR REPLACE FUNCTION private.list_method_releases_v1(p_offset integer DEFAULT 0)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO ''
...
declare org uuid:=private.require_vault_actor_v1();rows jsonb;bases jsonb;bindings jsonb;receipts jsonb;scope uuid;begin
 ...
 from private.platform_method_releases b join private.platform_capability_releases c on c.capability_key=b.capability_key where private.platform_method_reference_available_v1(b.id);
