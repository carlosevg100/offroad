...
- [ ] `SENTRY_AUTH_TOKEN` para stack trace **de servidor**. O bundle de servidor nunca é servido, então raspagem não alcança e só o upload resolve. É token de escrita, decisão do fundador criar e colar. O lado browser não depende disso.
