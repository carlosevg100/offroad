...
| Vercel | `carlosevg100-9887s-projects/offroad` | project member/owner atual | preview e frontend | production/preview | carlosevg100 | projeto criado; produção publicada; domínio anexado; Git integration pendente |
...
| GoDaddy | `offroad.capital` DNS | DNS editor | configurar targets dedicados exibidos pela Vercel | production | carlosevg100 | login interativo e edição DNS pendentes |
