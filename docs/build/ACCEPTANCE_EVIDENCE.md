...
* Staging recorded the migration as version `20260910193505` under the name `project_review_roles`; the applied statements are byte-identical to `supabase/migrations/20260910192032_project_review_roles.sql` (md5 `fd1cc2b93a75942114805df234fa7eb8` of the file without its trailing newline). The local file name is aligned to the production stamp at release.
